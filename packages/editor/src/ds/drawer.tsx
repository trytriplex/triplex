...
export function DrawerContent({
  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="slide-in fixed top-0 left-0 bottom-0 flex w-64 flex-col bg-neutral-900 text-neutral-300 shadow-2xl shadow-black/50 outline-none">
