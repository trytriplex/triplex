...
export function ScrollContainer({
  ...
  return (
    ...
    >
      ...
      >
        <ScrollArea.Thumb className="relative flex-1 rounded-xl bg-neutral-700 before:absolute before:top-1/2 before:left-1/2 before:h-full before:min-h-[44px] before:w-full before:min-w-[16px] before:-translate-x-1/2 before:-translate-y-1/2 before:content-['']" />
      </ScrollArea.Scrollbar>
