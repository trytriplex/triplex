...
### Does the Triplex native app use this packages version?

No the native app and installed package are separate, when the native app is
updated you should also update your installed package. We recommend using the
native app exclusively to not worry about upgrade drift.
