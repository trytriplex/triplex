...
<DownloadThanks>
  ...
  Discord](https://discord.gg/SUHCwfEk), follow the [Your First 3D Component
...
<KnowledgeCallout>
  ...
  and make sure to join the Poimandres [Discord
  community](https://discord.gg/SUHCwfEk).
</KnowledgeCallout>
...
- **Your Runtime**: Build with any React framework and JavaScript runtime, including [Next.js](https://nextjs.org/), [Remix](https://remix.run/), [Deno](https://deno.com/), [Bun](https://bun.com/), and more.
...
We have a community of hundreds building with Triplex. Join us on the Poimandres [Discord community](https://discord.gg/SUHCwfEk) or see [Community](/docs/community) for more ways to get involved.
