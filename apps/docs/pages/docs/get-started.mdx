...
Triplex is your visual workspace for building [React](https://react.dev) / [Three Fiber](https://r3f.docs.pmnd.rs) components. Focus on building your components and Triplex will manage everything else.
