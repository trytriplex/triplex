...
- Go To Definition — Navigates to the element in the code editor.
- Zoom To Element <Kbd>F</Kbd> — Positions and re-orients the camera on the element.
- Duplicate <Kbd>Cmd</Kbd> + <Kbd>D</Kbd> — Duplicates the element then focuses it.
- Group <Kbd>Cmd</Kbd> + <Kbd>G</Kbd> — Adds a group around the selected element.
- Delete <Kbd>Backspace</Kbd> — Deletes the element from the scene.
