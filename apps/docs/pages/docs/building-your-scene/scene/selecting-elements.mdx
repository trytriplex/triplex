...
To test your scenes interactivity click the <ActionLink icon={PlayIcon} href="/docs/building-your-scene/learn-the-ui/scene#play-scene" name="Play" /> action in the Scene Controls. See [Play Controls](/docs/building-your-scene/scene/play-controls) for more information.
