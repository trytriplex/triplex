...
description: Turn Visual Studio Code into your visual IDE.
---

Triplex for VS Code turns [Visual Studio Code](https://code.visualstudio.com) and [Cursor](https://www.cursor.com) into a visual IDE, bringing the best features of Triplex for you to stay in context while coding.
