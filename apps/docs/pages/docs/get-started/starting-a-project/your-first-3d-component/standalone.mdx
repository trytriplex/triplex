...
1. Click the <ActionLink icon={GearIcon} href="/docs/building-your-scene/learn-the-ui/scene#play-options" name="Settings" /> action next to the Play action to switch to other cameras.
