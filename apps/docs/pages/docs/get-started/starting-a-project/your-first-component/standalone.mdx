...
1. Click the <ActionLink icon={Pencil2Icon} href="/docs" name="Component Controls" /> action in the Scene Panel. The controls shown in the Context Area are the props the component accepts.
