...
Before continuing try adding a cylinder mesh. Make sure to save changes using the <ActionLink icon="⌘ + S" href="/docs/building-your-scene/learn-the-ui/other#save" name="Save" /> action!
...
1. With the point light selected, go to the Scene Panel and update the `name` prop to "Key light".
...
1. Copy the highlighted code into your component then jump back into Triplex for VS Code. The camera will appear in the scene.
...
1. Click the <ActionLink icon={Pencil2Icon} href="/docs/building-your-scene/learn-the-ui/scene-panel#openclose-component-controls" name="Component Controls" /> action in the ScenePanel. The controls shown in the Scene Panel are the props the component accepts.
