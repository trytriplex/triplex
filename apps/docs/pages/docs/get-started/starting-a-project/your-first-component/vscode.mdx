...
1. Click the <ActionLink name="Open in Triplex" href="/docs" /> CodeLens action above the Scene component. Nothing will appear in the scene yet.
...
Before continuing try adding a cylinder mesh. Make sure to save changes using the <ActionLink icon="⌘ + S" href="/docs" name="Save" /> action!
...
1. Click the <ActionLink icon={Pencil2Icon} href="/docs" name="Component Controls" /> action in the ScenePanel. The controls shown in the Scene Panel are the props the component accepts.
