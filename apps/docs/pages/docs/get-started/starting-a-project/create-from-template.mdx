...
description: Start building your next app using an official starter template.
---
...
Templates for creating all kinds of projects are [sourced from the official repository](https://github.com/trytriplex/triplex/tree/main/packages/create-triplex-project/templates). Want to suggest a new template? [Create an issue](https://github.com/trytriplex/triplex/issues/new) or pull request and let's get it added!
