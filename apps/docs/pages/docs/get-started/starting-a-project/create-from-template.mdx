...
description: Start building your next scene using an official template.
---

Creating a new project from a template is the fastest way to start building your next scene with Triplex.
