...
If this is you follow [How To Set Up Global Styles](/resources/how-to-set-up-tailwind) to get them showing up.
...
### Why is my component not able to be opened in Triplex?

For components to be opened in Triplex they must be exported from the file.
