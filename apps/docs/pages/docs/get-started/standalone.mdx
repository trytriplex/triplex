...
Find the <ButtonExample icon={DashboardIcon} href="/docs/building-your-scene/learn-the-ui/tab-bar" name="Open Component" /> action at the top left area of the user interface and click it to be presented a list of components to open.
