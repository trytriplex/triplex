...
Find the <ActionLink icon={DashboardIcon} name="Open Component" /> action at the top left area of the user interface and click it to be presented a list of components to open.
