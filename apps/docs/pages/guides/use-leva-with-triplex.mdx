...
description:
  Leva is a popular library to wire up controls to your components. With Triplex
  you can remove your glue code and instead use component props.
---
...
keeping your components portable by using component props instead of custom
code.
