...
date: 2023-11-22
description: This release introduces element drag and drop, file tabs, and a whole load of bug fixes.
author: Michael Dougall
---

▵ Triplex 0.61 introduces element drag and drop, file tabs, and a whole load of bug fixes. Have feedback? Join the Poimandres [Discord community](https://discord.gg/SUHCwfEk)!

## New features

- Drag & drop elements in the left panel to re-order and re-parent them [[#45](https://github.com/trytriplex/triplex/issues/45)]
- Open and switch between multiple files fast with tabs
- Save all opened files through the file menu

## Bug fixes

- Inputs now confirm their value when pressing enter [[#101](https://github.com/trytriplex/triplex/issues/101)]
- Transform controls now has capped precision [[#141](https://github.com/trytriplex/triplex/issues/141)]
- Undo/redo is now scoped to the active file [[#155](https://github.com/trytriplex/triplex/issues/155)]
...
- Remote calls are now scheduled to ensure high priority calls occur before low priority / expensive ones [[#158](https://github.com/trytriplex/triplex/issues/158)]
