...
▵ Triplex 0.60 introduces a new duplicate element action, improves element
actions overall user experience, and fixes some bugs.
...
- Flesh out a scene faster now by duplicating elements using the
  ...
  [[#117](https://github.com/trytriplex/triplex/issues/117)]
...
- IDE links now opened through the `launch-editor` package
  [[#142](https://github.com/trytriplex/triplex/issues/142)]
