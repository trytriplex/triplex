...
As always if you have thoughts, questions, or feedback, please reach out on the Poimandres [Discord community](https://discord.gg/SUHCwfEk). And [install Triplex for VS Code](https://marketplace.visualstudio.com/items?itemName=trytriplex.triplex-vsce) if you haven't already!
